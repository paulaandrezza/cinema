...
class Filme(ClasseBase):
  ...
  def consultar_todos(self):
    ...
    if resultado:
      print("{:<3} {:<30} {:<40} {:<15} {:<15} {:<15}".format("ID", "Nome", "Descrição", "Gênero", "Duração (min)", "Classificação"))
      for item in range(len(resultado)):
        print("{:<3} {:<30} {:<40} {:<15} {:<15} {:<15}".format(resultado[item][0], resultado[item][1], resultado[item][2], resultado[item][3], resultado[item][4], resultado[item][5]))
    input("\033[1;44m\nPressione <ENTER> para continuar...\033[m")
    return
